    ...
    sections: [
      ...
      },
      {
        ...
        rows: buildRows([
          ...
          ['干支五行复核', '核对体卦、用卦、动爻相关五行资料口径。 /tools/wuxing']
        ])
      }
    ]
  })
  ...
  return result({
    ...
    sections: [
      ...
      },
      {
        title: '下一步入口',
        rows: buildRows([
          ['干支五行速查', '核对天干地支、五行、藏干和生克资料口径。 /tools/wuxing'],
    ...
    sections: [
      ...
      },
      {
        ...
        rows: buildRows([
          ...
          ['干支五行复核', '核对天干地支、五行、方位和基础资料口径。 /tools/wuxing']
        ])
      }
    ]
  })
    ...
    sections: [
      ...
      },
      {
        ...
        rows: buildRows([
          ...
          ['干支五行复核', '核对天干地支、五行、月将和基础资料口径。 /tools/wuxing']
        ])
      }
    ]
  })
  ...
  return result({
    ...
    sections: [
      ...
      },
      {
        title: '下一步入口',
        rows: buildRows([
          ['黄历节气', '打开单日黄历详情，核对节气、冲煞、四柱、纳音和宜忌原文。 /tools/calendar'],
          ['十二时辰速查', '选定日期后继续筛当天时辰候选和地支五行字段。 /tools/shichen'],
          ['每日行动速览', '把最终候选日放入当天行动复核，补个人生肖和方位字段。 /tools/daily-fortune'],
          ['干支五行复核', '核对候选日干支、五行、藏干和生克资料口径。 /tools/wuxing']
        ])
      }
    ]
  })
  ...
  return result({
    ...
    sections: [
      ...
      },
      {
        title: '下一步入口',
        rows: buildRows([
          ['每日行动速览', '把梦境暴露出的现实压力转成今日行动复核。 /tools/daily-fortune'],
