...
export const xuanToolSuites = [
  {
    title: '出生盘排盘',
    eyebrow: 'Birth Chart',
    summary: '输入出生时间和出生地，优先处理真太阳时、宫位、四柱和可导出字段。',
    primaryHref: '/tools/bazi',
    toolHrefs: ['/tools/bazi', '/tools/ziwei'],
    steps: ['出生信息', '真太阳时', '排盘导出']
  },
  {
    title: '问事起卦',
    eyebrow: 'Question Chart',
    summary: '围绕具体事项记录卦象、动爻、世应、六亲和可复制文本。',
    primaryHref: '/tools/liuyao',
    toolHrefs: ['/tools/liuyao', '/tools/daily'],
    steps: ['填写事项', '指定卦象', '导出卦盘']
  },
  {
    title: '日课时间',
    eyebrow: 'Calendar',
    summary: '快速查询当天日课、节气、时辰、干支和常用时间换算字段。',
    primaryHref: '/tools/calendar',
    toolHrefs: ['/tools/calendar', '/tools/shichen'],
    steps: ['选定日期', '查看日课', '核对时辰']
  },
  {
    title: '基础资料库',
    eyebrow: 'Reference',
    summary: '把天干地支、五行、八卦和六十四卦做成可查资料，不和断语混在一起。',
    primaryHref: '/tools/wuxing',
    toolHrefs: ['/tools/wuxing', '/tools/hexagrams'],
    steps: ['查基础表', '核对关系', '辅助排盘']
  }
]
