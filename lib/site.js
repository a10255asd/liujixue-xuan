...
export const xuanPrimaryWorkflows = [
  {
    title: '出生排盘',
    eyebrow: 'Birth Chart',
    summary: '先把出生时间、出生地、真太阳时和排盘口径处理清楚，再输出八字和紫微排盘。',
    href: '/tools/bazi',
    action: '开始八字排盘',
    supportingHrefs: ['/tools/ziwei', '/tools/birth-time', '/tools/find-time'],
    checkpoints: ['出生信息', '口径核对', '下载图片']
  },
  {
    title: '问事起卦',
    eyebrow: 'Question Chart',
    summary: '围绕一个具体问题先做六爻排盘，梅花、塔罗和每日一卦可以补充记录不同视角。',
    href: '/tools/liuyao',
    action: '打开六爻排盘',
    supportingHrefs: ['/tools/meihua', '/tools/tarot', '/tools/daily'],
    checkpoints: ['明确事项', '生成卦盘', '下载图片']
  },
  {
    title: '资料查询',
    eyebrow: 'Reference',
    summary: '把黄历、择日、时辰、五行、卦象和古籍资料作为排盘前后的辅助查询。',
    href: '/classics',
    action: '打开资料入口',
    supportingHrefs: ['/tools/calendar', '/tools/date-selection', '/knowledge'],
    checkpoints: ['查资料', '核字段', '下载图片']
  }
]
