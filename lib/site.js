...
export const xuanTools = [
  ...
  },
  {
    ...
    href: '/tools/qimen',
    status: '第一版',
    summary: '按事项和时间输出阴阳遁、局数、值符值使、节气和九宫轮值字段。',
    tags: ['奇门', '九宫', '值符值使']
  },
  {
    title: '大六壬起课速览',
    href: '/tools/daliuren',
    status: '第一版',
    summary: '按事项和占时输出月将、日辰、占时、旬空、十二天将和课传速览字段。',
    tags: ['六壬', '月将', '课传']
  },
  {
    title: '黄历节气',
...
export const xuanToolSuites = [
  {
    ...
    steps: ['出生信息', '校时对照', '排盘导出']
  },
  {
    title: '问事起卦',
    eyebrow: 'Question Chart',
    summary: '围绕具体事项记录卦象、动爻、世应、六亲、体用和可复制文本。',
    primaryHref: '/tools/liuyao',
    toolHrefs: ['/tools/liuyao', '/tools/meihua', '/tools/daily'],
    steps: ['填写事项', '起卦排盘', '导出卦盘']
  },
  {
    title: '高阶术数',
    eyebrow: 'Advanced',
    summary: '先做奇门和六壬的起局字段、节气、局数、月将、课传和九宫轮值。',
  ...
  },
  {
    title: '资料记录',
    eyebrow: 'Reference',
    summary: '把六十四卦、古籍索引、知识图解和本地记录集中管理，形成可继续扩展的资料层。',
    primaryHref: '/tools/records',
    toolHrefs: ['/tools/hexagrams', '/classics', '/knowledge', '/tools/records'],
    steps: ['查资料', '看图解', '存记录']
  }
]
