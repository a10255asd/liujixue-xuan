...
export const xuanTools = [
  ...
  },
  {
    ...
    href: '/tools/dream',
    status: '已上线',
    summary: '记录梦境全文、醒来情绪、人物场景和反复意象，生成可交给 AI 接力的整理材料。',
    tags: ['梦境', '记录', 'AI 接力']
  },
  {
    title: '每日一卦',
...
export const xuanPrimaryWorkflows = [
  {
    title: '出生排盘',
    eyebrow: 'Birth Chart',
    summary: '先把出生时间、出生地、真太阳时和排盘口径处理清楚，再输出八字、紫微和合盘材料。',
    href: '/tools/bazi',
    action: '开始八字排盘',
    supportingHrefs: ['/tools/ziwei', '/tools/birth-time', '/tools/find-time', '/tools/compatibility'],
    checkpoints: ['出生信息', '口径核对', '导出材料']
  },
  {
    title: '问事起卦',
    ...
    checkpoints: ['明确事项', '生成卦盘', '保存记录']
  },
  {
    title: '记录接力',
    eyebrow: 'Handoff',
    summary: '把排盘文本、图片和问题背景沉淀到记录中心，再送去 AI 提示词或综合合参工作台。',
    href: '/tools/records',
    action: '进入记录中心',
    supportingHrefs: ['/tools/ai-prompt', '/tools/synthesis'],
    checkpoints: ['保存记录', '生成提示词', '合参整理']
  }
]
...
export const xuanToolSuites = [
  ...
  },
  {
    title: '资料记录',
    eyebrow: 'Reference',
    summary: '把六十四卦、古籍索引、知识图解、本地记录、梦境材料、AI 接力和综合合参集中管理，形成可继续扩展的资料层。',
    primaryHref: '/tools/records',
    toolHrefs: ['/tools/hexagrams', '/classics', '/knowledge', '/tools/dream', '/tools/records', '/tools/ai-prompt', '/tools/synthesis'],
    steps: ['查资料', '看图解', '合参接力']
  }
]
...
export const xuanComingTools = [
  {
    title: '记录备份',
    status: '可导出',
    summary: '收藏和记录保存在当前浏览器，重要材料可以通过 JSON 导出备份。'
  },
  {
    title: 'AI 接力',
    status: '已上线',
    summary: '把排盘字段整理成提示词，方便继续交给 AI 或人工老师复核。'
  }
]
...
export const featureBlocks = [
  ...
  {
    title: '记录可备份',
    text: '本地历史、收藏、对盘资料和工具记录都可以导出 JSON，方便备份和迁移。'
  }
]
